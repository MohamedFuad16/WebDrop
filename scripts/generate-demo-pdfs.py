...
COPY = {
    "en": {
        ...
        "cover_summary": (
            "A visual and technical guide to the WebDrop 1.0.19 prototype. "
        ...
        "overview_cards": [
            ...
            (
                ...
                "Version 1.0.19 proves the mobile-first interaction, responsive orbit "
        ...
        "catalog_subtitle": "Approved WebDrop 1.0.19 UI inventory",
    ...
    "ja": {
        ...
        "cover_summary": (
            "WebDrop 1.0.19の画面と技術をまとめたデモガイドです。"
        ...
        "overview_cards": [
            ...
            (
                "このビルドで確認できること",
                "バージョン1.0.19では、モバイル中心の操作、レスポンシブな軌道UI、日英切替、"
        ...
        "catalog_title": "UIガイド",
        "catalog_subtitle": "承認済みWebDrop 1.0.19画面一覧",
        "roadmap_title": "今後の予定",
        "roadmap_statement": (
...
JP_ITEMS = {
    ...
    "settings-app-version": ("アプリバージョン", "設定画面の下部に現在のプロトタイプバージョン1.0.19を表示します。"),
...
def draw_cover(
    ...
    c.setFillColor(WHITE)
    c.setFont(bold, 9)
    c.drawCentredString(MARGIN + 45.5, PAGE_H - 350, "VERSION 1.0.19")
...
def build_pdf(locale: str, items: Sequence[dict[str, str]], fonts: dict[str, str]) -> Path:
    ...
    c.setAuthor("WebDrop")
    c.setSubject("WebDrop 1.0.19 interface and architecture guide")
