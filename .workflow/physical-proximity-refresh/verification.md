...
- `npm run test:e2e` passed on `1.0.52`: 53 passed, 47 expected project skips.
...
- Release `1.0.52` adds live acoustic slot diagnostics to the Dynamic Island: emitting/listening/detected/missed slot, emitted count, margin, and frequency band are now surfaced during the physical ceremony.
