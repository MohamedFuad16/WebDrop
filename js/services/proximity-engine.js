import { AcousticProximitySensor, MIN_INAUDIBLE_FREQUENCY_HZ } from "./acoustic-proximity.js?v=1.0.126";
import { MotionProximitySensor } from "./motion-proximity.js?v=1.0.126";
import { createQrToken, validateQrToken } from "./proximity-token.js?v=1.0.126";
...
export class ProximityEngine {
  ...
  async sampleAcousticFrequencyBand(options) {
    return this.acoustic.sampleFrequencyBand(options);
  }

  async sampleAcousticFrequencyBands(options) {
    return this.acoustic.sampleFrequencyBands(options);
  }
