import { createOperationsI18n } from "./operations-i18n.js?v=1.0.116";
import { DiagnosticsApi } from "./diagnostics-api.js?v=1.0.116";
import { apiBaseFrom, escapeHtml, formatAge, formatFrequency, formatNumber } from "./shared.js?v=1.0.116";
import {
  TEST_CASES,
  createTestRun,
  ingestTestRun,
...
const LOCAL_ADMIN_TOKEN_URL = new URL("../config/local-admin-token.js?v=1.0.116", import.meta.url);
