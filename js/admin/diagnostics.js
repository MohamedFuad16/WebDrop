import { DiagnosticsApi } from "./diagnostics-api.js?v=1.0.75";
import { createOperationsI18n } from "./operations-i18n.js?v=1.0.75";
import { AcousticProximitySensor } from "../services/acoustic-proximity.js?v=1.0.75";
import {
  apiBaseFrom,
  escapeHtml,
  formatAge,
