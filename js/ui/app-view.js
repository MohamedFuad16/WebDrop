...
import { AVATAR_OPTIONS, animatedFramesForAvatar, normalizeAvatarChoice } from "../config/avatar-options.js?v=1.0.83";
import { translate } from "../config/i18n.js?v=1.0.83";
import { DynamicIsland } from "./dynamic-island.js?v=1.0.83";
